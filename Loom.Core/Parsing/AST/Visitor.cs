...
public abstract class Visitor<T>(Func<Node?, T> defaultValue)
{
    ...
    public virtual T VisitQualifiedNamePattern(QualifiedNamePattern qualifiedNamePattern) => Visit(qualifiedNamePattern.Name);
    ...
    public virtual T VisitWithOperator(WithOperator withOperator) => CombineResults([Visit(withOperator.Expression), Visit(withOperator.Body)]);
